...
namespace AtvaltOOP.Tests
{
    ...
    public class AtvaltTests
    {
        ...
        {
            double atvalt = new Atvalt("1101");
            double eredmeny = atvalt.AtvaltToTizes();
        ...
        {
            double atvalt = new Atvalt("13");
            double eredmeny = atvalt.AtvaltToBinaris();
        ...
        {
            double ex = Assert.Throws<ArgumentException>(() => new Atvalt("1234"));
        ...
        {
            double ex = Assert.Throws<ArgumentException>(() => new Atvalt(""));
        ...
        {
            double ex = Assert.Throws<ArgumentException>(() => new Atvalt("abc"));
